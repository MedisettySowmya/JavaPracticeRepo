...
public class ConfirmationAlerts {
	public static void main(String[] args) throws Exception {
		...
		WebElement confirmationAlertBtn = driver.findElement(By.id("confirmButton"));
		System.out.println("==> Located 'confirmationAlertBtn'.");
		...
		System.out.println("==> Clicked 'confirmationAlertBtn'. Waiting for alert...");
		...
		System.out.println("==> Switched to alert. Alert text: " + confirmationAlert.getText());

		Thread.sleep(2000);

		// Accept the alert
		//confirmationAlert.accept();
		//String confirmationAlertAccepted = driver.findElement(By.id("confirmResult")).getText();

		confirmationAlert.dismiss();
		String confirmationAlertDismissed = driver.findElement(By.id("confirmResult")).getText();
		System.out.println(confirmationAlertDismissed);
